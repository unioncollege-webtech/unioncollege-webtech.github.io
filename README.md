...
An introduction to server and client side web programming using JavaScript and other web technologies.

* **Course:** CPTR 335 - Web Technologies
* **Instructor:** Benjamin Barber, [barberboy@gmail.com](mailto:barberboy@gmail.com)
* **Need help?**
  * Join and ask questions in the Gitter chat room <img src="https://badges.gitter.im/Join%20Chat.svg" alt="join" style="vertical-align: middle;">
...
- [Intro to JavaScript](https://barberboy.github.io/intro-to-javascript)
...
1. Fork the [exercise repository](#exercises)
...
All assignments are due at the start of the following class, unless otherwise specified.
